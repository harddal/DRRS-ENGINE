...
/*
	// LIGHTNING BOLTS!
	irr::scene::CBoltSceneNode* beam = new irr::scene::CBoltSceneNode(smgr->getRootSceneNode(), smgr, -1, "lightning.bmp");
...
{ 
    ...
    { 
        ...
        { 
        public: 
            CBoltSceneNode( scene::ISceneNode* parent, scene::ISceneManager *mgr, s32 id,const char* szBeam ); 
			...
			void setLine(core::vector3df start, core::vector3df end, u32 updateTime = 300, f32 height = 10, u32 parts = 10, u32 bolts = 1, bool steddyend = true, f32 thick=5.0f , video::SColor color = video::SColor(255,255,0,0)); 
        protected: 
            struct Bolt 
            { 
                u32 m_height; 
