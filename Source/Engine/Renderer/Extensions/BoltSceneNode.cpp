...
namespace irr
{
	namespace scene
	{
		CBoltSceneNode::CBoltSceneNode(scene::ISceneNode* parent, scene::ISceneManager *mgr, s32 id, const char* szBeam) : ISceneNode(parent, mgr, id)
		{
			//ctor 
		...
		void CBoltSceneNode::setLine(core::vector3df start, core::vector3df end, u32 updateTime, f32 height, u32 parts, u32 bolts, bool steddyend, f32 thick, video::SColor color)
		{
			setPosition(start);
			m_thickness = thick;
			srand(parts);
