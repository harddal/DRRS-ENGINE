...
switch (goreLevel)
{
  case EGL_MILD :
  {
    ...
    maxLife      = 600;
    maxAngle     = 5;
    minSize      = dimension2df(0.2f, 0.2f);
    maxSize      = dimension2df(0.25f, 0.25f);
  } break;
  ...
  case EGL_MEDIUM :
  {
    ...
    maxLife      = 700;
    maxAngle     = 7;
    minSize      = dimension2df(0.3f, 0.3f);
    maxSize      = dimension2df(0.35f, 0.35f);
  } break;
  ...
  case EGL_BRUTAL :
  {
    ...
    maxLife      = 750;
    maxAngle     = 10;
    minSize      = dimension2df(0.4f, 0.4f);
    maxSize      = dimension2df(0.45f, 0.45f);
  } break;
  ...
  case EGL_INSANE :
  {
    ...
    maxLife      = 900;
    maxAngle     = 12;
    minSize      = dimension2df(0.55f, 0.55f);
    maxSize      = dimension2df(0.55f, 0.55f);
  } break;
}
...
ps1->setMaterialTexture(0, driver->getTexture("content/texture/particle/blood1.png"));
...
ps2->setMaterialTexture(0, driver->getTexture("content/texture/particle/blood2.png"));
...
ps3->setMaterialTexture(0, driver->getTexture("content/texture/particle/blood3.png"));
...
ps4->setMaterialTexture(0, driver->getTexture("content/texture/particle/blood4.png"));
...
ps5->setMaterialTexture(0, driver->getTexture("content/texture/particle/blood5.png"));
