...
namespace IRR
{
	...
	*/
	...
	public :
		...
		void setMaterialType(irr::video::E_MATERIAL_TYPE type) { material.MaterialType = type; }
		irr::video::E_MATERIAL_TYPE getMaterialType() const    { return material.MaterialType; }

		void setTexture(irr::u32 layer, irr::video::ITexture* tex) { material.TextureLayer[layer].Texture = tex; }
