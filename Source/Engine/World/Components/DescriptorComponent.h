...
// TODO: Add revelent tags to entities when they are made in their revelvent systems
enum ENTITY_TYPE
{
    ET_NULL,
    ET_STATIC,
...
struct DescriptorComponent : anax::Component
{
    ...
    void load(Archive& archive)
    {
        ...
        // isDebug/isSerializable added later; old files omit them — keep constructor defaults.
        try { archive(CEREAL_NVP(isDebug), CEREAL_NVP(isSerializable)); } catch (...) {}
    }
