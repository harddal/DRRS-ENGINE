...
// Alpha-tested grass blades with PBR lighting.
// Combines the alpha discard from foliage.frag with the wind-animated
// grass.vert to produce swaying, cut-out grass patches.
// Two-sided shading is enabled so thin blade geometry is lit from both sides.

#define MAX_LIGHTS 8
#define PI 3.14159265358979323846
#define ALPHA_CUTOFF 0.4
